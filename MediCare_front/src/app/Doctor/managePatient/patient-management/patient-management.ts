...
export class PatientManagement implements OnInit {
  // Signal Source - Données du patient - Il sert à stocker le patient et initialiser PatientService.
  patient = signal<User | null>(null);

  // l'ID du patient selectionner dans doctor-list-patient
  ...
  this.route.paramMap.subscribe(params => {
    ...
    if (idParam) {
      ...
      this.patientService.patientId.set(id)
      console.log("PatientID service:", this.patientService.patientId())
      console.log("patientId patientmanagement", this.patientId())
